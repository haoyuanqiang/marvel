...
package org.marvel.gateway.service;

import org.marvel.gateway.configuration.FeignConfiguration;
import org.marvel.gateway.model.MarvelResponse;
import org.marvel.gateway.model.VerificationResult;
import org.marvel.gateway.service.impl.FeignAuthServiceImpl;
...
@FeignClient(
        name = "marvel-auth",
        fallback = FeignAuthServiceImpl.class,
        configuration = FeignConfiguration.class)
public interface FeignAuthService {

    @PostMapping("/verification")
    public MarvelResponse<VerificationResult> checkPermission(
