...
import { ApartmentOutlined, FieldTimeOutlined, MailOutlined, MobileOutlined, UserOutlined } from '@ant-design/icons';
    ...
    return (
      ...
      >
        <List.Item>
          <Space>
            <UserOutlined />
            <span><Text strong>用户名称</Text></span>
          </Space>
        ...
        <List.Item>
          <Space>
            <MobileOutlined />
            <span><Text strong>手机号码</Text></span>
          </Space>
          <span style={{ float: 'right' }}>
            {_.get(userInfo, 'telephone', '')}
          </span>
        </List.Item>
        <List.Item>
          <Space>
            <MailOutlined />
            <span><Text strong>用户邮箱</Text></span>
          </Space>
          <span style={{ float: 'right' }}>
        ...
        <List.Item>
          <Space>
            <ApartmentOutlined />
            <span><Text strong>所属部门</Text></span>
          </Space>
          <span style={{ float: 'right' }}>
        ...
        <List.Item>
          <Space>
            <FieldTimeOutlined />
            <span><Text strong>更新时间</Text></span>
          </Space>
          <span style={{ float: 'right' }}>
